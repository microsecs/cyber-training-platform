...
export default function CourseAdminPage() {
  ...
  const [quiz, setQuiz] = useState<any[]>(emptyQuiz);
  ...
  function loadCourse(course: Course) {
    ...
    setQuiz(
      course.quiz && course.quiz.length
        ? course.quiz
        : emptyQuiz
    );
    setMessage("");
  ...
  return (
    <main className="mx-auto max-w-7xl px-6 py-10">
      ...
      <p className="mt-2 text-slate-400">
        Manage training videos, descriptions, quiz questions, and passing scores.
      </p>
      ...
      <div className="mt-8 grid gap-6 lg:grid-cols-[.7fr_1.5fr]">
        ...
        <section className="rounded-2xl border border-white/10 bg-slate-900 p-6">
          <div className="grid gap-5 md:grid-cols-2">
            ...
            <div>
              <label className="mb-2 block text-sm">Passing Score (%)</label>
              <input
                type="number"
                min={0}
                max={100}
            ...
            <div className="md:col-span-2">
              ...
              <p className="mt-2 text-xs text-slate-500">
                Use a direct MP4/WebM URL or another browser-playable source for now.
              </p>
            </div>
